local msurfboardassets = {
    ...
    Asset("ATLAS", "images/inventoryimages/boat_msurfboard.xml"),
    Asset("IMAGE", "images/inventoryimages/boat_msurfboard.tex"),
}
...
local function item_common()
    ...
    inst.components.inventoryitem.imagename = "boat_msurfboard"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/boat_msurfboard.xml"
