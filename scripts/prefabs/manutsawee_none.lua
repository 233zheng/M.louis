...
table.insert(prefabs, 	CreatePrefabSkin("manutsawee_fuka",
{
	base_prefab = "manutsawee",
	build_name_override = "manutsawee_fuka",
	type = "base",
	rarity = "Elegant",
	skip_item_gen = true,
	skip_giftable_gen = true,
...
table.insert(prefabs, 	CreatePrefabSkin("manutsawee_maid",
{
	base_prefab = "manutsawee",
	build_name_override = "manutsawee_maid",
	type = "base",
	rarity = "Elegant",
	skip_item_gen = true,
	skip_giftable_gen = true,
...
table.insert(prefabs, 	CreatePrefabSkin("manutsawee_jinbei",
{
	base_prefab = "manutsawee",
	build_name_override = "manutsawee_jinbei",
	type = "base",
	rarity = "Elegant",
	skip_item_gen = true,
	skip_giftable_gen = true,
...
table.insert(prefabs, 	CreatePrefabSkin("manutsawee_shinsengumi",
{
	base_prefab = "manutsawee",
	build_name_override = "manutsawee_shinsengumi",
	type = "base",
	rarity = "Elegant",
	skip_item_gen = true,
	skip_giftable_gen = true,
	skin_tags = { "BASE", "MANUTSAWEE", "SURVIVOR"},
	skins = {
		normal_skin = "manutsawee_shinsengumi",
		ghost_skin = "ghost_manutsawee_build",
	},
